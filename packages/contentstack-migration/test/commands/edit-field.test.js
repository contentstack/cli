...
describe('Edit field test', () => {
  ...
  describe('prepare for edit field test', () => {
    nockBack('edit-field.json', nockDone => {
      test
      .stdout()
      .command(['cm:migration', '-n', `${migrationPath}/edit-field/edit-field.js`, '-A', '-k', 'bltd8f5f521adc4b5b3'])
      ...
      // test
      // .stdout()
      // .command(['cm:migration', '-n', `${migrationPath}/edit-field/edit-invalid-field.js`, '-A', '-k', 'bltd8f5f521adc4b5b3'])
      ...
      test
      .stdout()
      .command(['cm:migration', '-n', `${migrationPath}/edit-field/edit-invalid-method.js`, '-A', '-k', 'bltd8f5f521adc4b5b3'])
