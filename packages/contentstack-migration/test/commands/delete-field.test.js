...
describe('Delete field test from migration script', () => {
  ...
  describe('Delete field', () => {
    nockBack('delete-field.json', nockDone => {
      test
      .stdout()
      .command(['cm:migration', '-n', `${migrationPath}/delete-field/delete-field.js`, '-A', '-k', 'bltd8f5f521adc4b5b3'])
      ...
      test
      .stdout()
      .command(['cm:migration', '-n', `${migrationPath}/delete-field/delete-invalid-field.js`, '-A', '-k', 'bltd8f5f521adc4b5b3'])
