...
describe('Move field test from migration script', () => {
  ...
  describe('Move field', () => {
    nockBack('move-field.json', nockDone => {
      test
      .stdout()
      .command(['cm:migration', '-n', `${migrationPath}/move-field/move-field.js`, '-A', '-k', 'bltd8f5f521adc4b5b3'])
      ...
      test
      .stdout()
      .command(['cm:migration', '-n', `${migrationPath}/move-field/move-invalid-method.js`, '-A', '-k', 'bltd8f5f521adc4b5b3'])
