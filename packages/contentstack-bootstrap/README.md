...
@contentstack/cli-cm-bootstrap/1.0.4 linux-x64 node-v12.22.7
$ csdx --help [COMMAND]
USAGE
  $ csdx COMMAND
...
...
_See code: [src/commands/cm/bootstrap.ts](https://github.com/contentstack/cli/blob/v1.0.4/src/commands/cm/bootstrap.ts)_
<!-- commandsstop -->
