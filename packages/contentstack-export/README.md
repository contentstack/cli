...
@contentstack/cli-cm-export/0.0.28 linux-x64 node-v12.13.1
$ csdx --help [COMMAND]
USAGE
  $ csdx COMMAND
...
...
_See code: [src/commands/cm/export.js](https://github.com/contentstack/cli/blob/v0.0.28/packages/contentstack-export/src/commands/cm/export.js)_
<!-- commandsstop -->
