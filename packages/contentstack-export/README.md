...
@contentstack/cli-cm-export/0.1.1-beta.4 darwin-x64 node-v13.14.0
$ csdx --help [COMMAND]
USAGE
  $ csdx COMMAND
...
...
_See code: [src/commands/cm/export.js](https://github.com/contentstack/cli/blob/v0.1.1-beta.4/packages/contentstack-export/src/commands/cm/export.js)_
<!-- commandsstop -->
