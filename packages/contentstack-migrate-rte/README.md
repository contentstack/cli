...
running command...
$ csdx (--version)
@contentstack/cli-cm-migrate-rte/1.4.22 darwin-arm64 node-v22.13.1
$ csdx --help [COMMAND]
USAGE
  $ csdx COMMAND
...
...
FLAGS
  ...
  --global-field             Checks whether the specified UID belongs to a content type or a global field. This flag is
