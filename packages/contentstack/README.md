...
running command...
$ csdx (--version|-v)
@contentstack/cli/1.44.2 darwin-arm64 node-v23.11.0
$ csdx --help [COMMAND]
USAGE
  $ csdx COMMAND
...
...
_See code: [@contentstack/cli-config](https://github.com/contentstack/cli/blob/main/packages/contentstack-config/src/commands/config/mfa/add.ts)_
...
_See code: [@contentstack/cli-config](https://github.com/contentstack/cli/blob/main/packages/contentstack-config/src/commands/config/mfa/remove.ts)_
...
FLAGS
  -d, --data-dir=<value>  [default: /Users/raj.pandey/cli89/cli/packages/contentstack] Current working directory
